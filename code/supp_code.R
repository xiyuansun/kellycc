...
sc18_alter_pval <- NBsim_scenario(params=trimmed_parms,
                                  nGenes=1000, 
                                  nSample=16, 
                                  pDiff=0.01, nSim=5)

saveRDS(sc18_alter_pval, "./sim/results/sc16_alter_pval.rds")
...
saveRDS(all_pval, file=paste0("./sim/results/","sim_genes_",nGenes,"_g_",nRep, "_pDiff_",diffPerc, "_",i,"_pval",
                              ".rds"))
sc18_sim4_auc <- plot_roc_all(all_result=all_pval, name="sc18 sim4")
saveRDS(sc18_sim4_auc, file=paste0("./sim/results/","sim_genes_",nGenes,"_g_",nRep, "_pDiff_",diffPerc, "_",i,"_auc",
                                   ".rds"))
##########################################################################################################################
